...
profession_to_skill[GetSpellInfo(13977859)] = "Woodcutting"
...
tracking_spells[(GetSpellInfo(109498))] = "Woodcutting"
	...
	args = {
		...
		auto_group = {
			...
			args = {
				...
				woodcutting = {
					name = L["Woodcutting"], type = "select",
					desc = L["Routes with Woodcutting"],
					order = 600,
					values = prof_options,
					arg = "Woodcutting",
				},
